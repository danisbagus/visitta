  ...
  async up(queryInterface, Sequelize) {
    const spots = [
      ...
      },
      {
        ...
        filename: "samples/kedung-tumpang_lzbfii",
      },
      {
        id: crypto.randomUUID(),
        ...
        filename: "samples/lumbung_hb1ivo",
      },
      {
        id: crypto.randomUUID(),
        ...
        filename: "samples/banyu-mulok_vihcxr",
      },
      {
        id: crypto.randomUUID(),
        ...
        filename: "samples/sanggar_l7few2",
      },
      {
        id: crypto.randomUUID(),
        ...
        filename: "samples/ranu-gumbolo_cwnlsw",
      },
      {
        id: crypto.randomUUID(),
      ...
      },
      {
        ...
        filename: "samples/alas-kandung_pswdok",
      },
      {
        id: crypto.randomUUID(),
        ...
        filename: "samples/dendy-sky-view_ygh06e",
      },
      {
        id: crypto.randomUUID(),
        ...
        filename: "samples/mbalong-kawok_xoltvb",
      },
    ];
